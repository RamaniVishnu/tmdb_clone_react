...
function Movies() {
    ...
    <Header />
    {/* `url('${background}')` */}
    <div className='movie_header' style={{background: `linear-gradient(rgba(3,37,65, 0.8) 0%, rgba(3,37,65, 0) 100%),url('https://www.themoviedb.org/t/p/w1920_and_h800_multi_faces${data[1].backdrop_path}')`}}>
   <div className="header_column">
    ...
    <div>
    <div className='data_name'> {data[12].name}
   ...
   <div className='percentage'>
    ...
    <div className='overview'>
        ...
        <p className='overview_para9'>{data[20].overview}</p>
    </div>
    <div className='created'>
    {data[2].created_by.length !== 0 && data[2].created_by[0].name !== undefined?
        <div><h4 className='creator_name'>{data[2].created_by[0].name}</h4>
    ...
    <Footer/>
    </> : <div> Products............... the data not obtained
    <Shimmer />
    </div>
